...
class SlackNotifier
{
    const CH_SLACK_SMDMITRY = 'smdmitry';
    const CH_SLACK_FSRATING = 'fsrating';
    const CH_SLACK_TESTGROUP = 'testgroup';

    public static function send($channel, $message)
    {
        $slack = new Slack(\Phalcon\DI::getDefault()->config->slack->token);
