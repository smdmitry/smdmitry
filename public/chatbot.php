...
$ввод = isset($_POST['text']) ? $_POST['text'] : (isset($_GET['text']) ? $_GET['text'] : '');
$запрос = $ввод;
$output = '';
...
$output = $фразы [$настроение] [$память [$настроение]];

end:
header("Access-Control-Allow-Origin: *");
//echo iconv('CP1251', 'UTF8', $output);
echo $output;
